...
use Illuminate\Support\Facades\Route;
    ...
    Route::middleware('auth:sanctum')->post('update-device-key',[UserController::class,'handleDeviceKeyUpdateOrCreate']);
    Route::middleware('auth:sanctum')->prefix("room")->namespace("User")->group(function(){
