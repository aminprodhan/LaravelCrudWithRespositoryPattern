...
use Illuminate\Support\Facades\Route;
    ...
    Route::middleware('auth:customer')->post('update-device-key',[CustomerController::class,'handleDeviceKeyUpdateOrCreate']);
    Route::middleware('auth:customer')->prefix("reservation")->namespace("Customer")->group(function(){
